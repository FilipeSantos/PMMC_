<?php
   ...
   $cidadesDiv = Cidade::get_cidades_classificacao_divisao($divisao);
?>
         ...
         <table class="tbVotos tbClass">
            ...
            <?php foreach($cidadesDiv as $cidade) : ?>
               <tr>
                  ...
                  <td align="center"><?php echo number_format($cidade->pontos, 1, ',', '.'); ?></td>
                  <td align="center"><a class="btnEditar" href="/admin/classificacao/adicionar.php?id=<?php echo $cidade->id; ?>">[Editar]</a></td>
               </tr>
