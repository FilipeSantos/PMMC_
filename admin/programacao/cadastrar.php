<?php
   ...
   $listModalidades = new Modalidade();
   $listModalidades = $listModalidades->get_modalidades();
?>
   ...
   <body class="releases">
      <div id="wrapper">
         ...
         <div id="contentTb">
            <h2>Programação - Cadastrar</h2>
            <ul id="menuSubSec">
               <li><a<?php echo isset($pg_programacao) && !isset($pg_programacao_cadastrar) ? ' class="hover"' : ''; ?> href="/admin/programacao.php">Home</a></li>
