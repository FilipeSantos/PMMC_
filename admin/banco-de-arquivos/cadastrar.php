...
?>
   ...
   <head>
      <title>Jogos Abertos do Interior de 2011 - Admin - Banco de Arquivos - Cadastrar</title>
      <meta name="title" content="Jogos Abertos do Interior de 2011 - Admin - Banco de Arquivos - Cadastrar" />
   ...
   <body class="bd-arquivos">
      <div id="wrapper">
         ...
         <div id="contentTb">
            <h2>Banco de Arquivos - Cadastrar</h2>
            <ul id="menuSubSec">
               <li><a href="/admin/banco-de-arquivos.php">Home</a></li>
               <li><a class="hover" href="/admin/banco-de-arquivos/cadastrar.php">Cadastrar</a></li>
            </ul>
            <br clear="all" />
            <div class="infoSecao">
               <p>* Campos Obrigatórios</p>
            </div>
            <?php require_once($_SERVER['DOCUMENT_ROOT'] . '/admin/_inc/formBanco.php'); ?>
         </div>
