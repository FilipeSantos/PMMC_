...
(function() {
	tinymce.create('tinymce.plugins.tinybrowser', {
		init : function(ed, url) {
			...
			// Register commands
			ed.addCommand('tinybrowser', function() {
				ed.windowManager.open({
                                        file : url + '/tinybrowser.php',
                                        width : 320 + ed.getLang('tinybrowser.delta_width', 0),
                                        height : 120 + ed.getLang('tinybrowser.delta_height', 0),
                                        inline : 1
                                }, {
