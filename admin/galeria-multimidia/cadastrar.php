...
?>
   ...
   <body class="releases">
      <div id="wrapper">
         ...
         <div id="contentTb">
            <h2>Galeria Multimídia - Cadastrar</h2>
            <ul id="menuSubSec">
               <li><a<?php echo isset($pg_releases) ? ' class="hover"' : ''; ?> href="/admin/galeria-multimidia.php">Home</a></li>
               <li><a<?php echo isset($pg_release_cadastrar) ? ' class="hover"' : ''; ?> href="/admin/galeria-multimidia/cadastrar.php">Cadastrar</a></li>
            </ul>
            <br clear="all" />
            <div class="infoSecao">
            ...
            <?php $edit = FALSE; ?>
            <?php require_once($_SERVER['DOCUMENT_ROOT'] . '/admin/_inc/formGaleria.php'); ?>
         </div>
